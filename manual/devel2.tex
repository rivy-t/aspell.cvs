...
This manual is designed for those who which to develope Aspell. It
...
\end{itemize}
\end{enumerate}
A FilterChar is a struct which contains the characters value in Unicode
and the {}``width'' of the character. ...

The standard \textbf{encoder} and \textbf{decoder} filters are defined
in common/convert.cpp. There should generally not be any need to deal
with them so they will not be discussed here.
